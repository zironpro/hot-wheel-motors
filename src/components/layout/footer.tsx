        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4 mt-2">
              <a href="#" className="w-10 h-10 rounded-lg border border-primary/20 flex items-center justify-center text-muted hover:text-primary hover:border-primary transition-colors">
